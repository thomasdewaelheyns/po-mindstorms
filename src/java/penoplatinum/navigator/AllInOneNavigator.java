...
public class AllInOneNavigator implements Navigator {
  ...
  int lastBarcode = Barcode.None;

  @Override
  public int nextAction() {

    if (this.model.getBarcode() != Barcode.None) {
      lastBarcode = this.model.getBarcode();
    }
  ...
  /**
   * This stores the driving actions the navigator must perform given a barcode
   * @param barcode
   * @return 
   */
  public void applyBarcode(int barcode) {
