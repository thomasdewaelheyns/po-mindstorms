...
import penoplatinum.modelprocessor.PacmanModelProcessor;
...
//  private int[] sweepAngles = new int[]{-105, -90, -75, -30, 0, 30, 75, 90, 105};
  ...
  private ModelProcessor processors;
  ...
  private void setupModel(String name) {
    ...
    this.processors = new IRModelProcessor(
                 new PacmanModelProcessor());
    this.processors.setModel(model);
    ModelProcessor proc =
