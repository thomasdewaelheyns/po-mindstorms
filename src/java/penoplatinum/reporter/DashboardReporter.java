...
public class DashboardReporter implements Reporter {
  ...
  private void sendModelDeltas() {
    ...
    this.clear()
        ...
        .add(this.model.getSensorPart().getSonarAngle()                  .c()
        .add(this.model.getSensorPart().getSonarDistance())              .c()
        .add(this.model.getSensorPart().getSonarValue(0))                .c()
        .add(this.model.getSensorPart().getSonarValue(1))                .c()
        .add(this.model.getSensorPart().getSonarValue(2))                .c()
        .add(this.model.getSensorPart().getSonarValue(3))                .c()
        .add(this.model.getSensorPart().getSonarValue(4))                .c()
