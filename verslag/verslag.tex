...
\chapter{Strategie}
TODO: De decentrale strategie die gebruikt wordt voor samenwerking om Pac-Man te vangen. Hoe
wordt omgegaan met onzekere, incomplete en incorrecte (van andere robots) informatie?
...
TODO:De effectiviteit van de strategie: hoe snel wordt Pac-Man in een hoek gedreven en klem
gereden?

\chapter{Softwaredesign}

TODO:Het software ontwerp van de robot. Is het ontwerp voldoende gebaseerd op onderzoek naar
bestaande benaderingen uit de multi-agent systemen literatuur? Zijn de voor- en nadelen
van tenminste een alternatief onderzocht?
...
\section{ //TODO AANVULLEN + GEPASTE TITEL } De simulator. Het software ontwerp en de correspondentie met de echte wereld. Is de granu-
lariteit van de simulatie zodanig dat de relevante eigenschappen van de wereld gesimuleerd
worden? Zijn er experimenten gedaan om de nauwkeurigheid van de simulator te testen?
...
(a) Welke moeilijkheden heb je ondervonden tijdens de uitwerking?
(b) Welke lessen heb je getrokken uit de manier waarop je het project hebt aangepakt?
(c) Hoe verliep het werken in het team? Op welke manier werd de teamcoordinatie en planning aangepakt?
...
Na de grote teleurstelling in demo 2 beslisten we onze aandacht op de architectuur en de code vol te houden. Onze refactoring aanpak werd wel aangevuld met het creeren van een uitgebreid unit test package. Waarbij op het moment van schrijven een dekking van meer dan vijftig percent van de totale codebase is bereikt. Een dekking van honderd percent is natuurlijk nutteloos en dus gaan we enkel voor een dekking van de relevante klassen. Bij de creatie van dit package werd tegelijk bijna alle code gereviewed. Zo werd er veel ongebruikte code verwijderd en haalden we er een reeks bugs uit. We geloven er sterk in dat dit proces onze code veel stabieler heeft gemaakt en onze robot hier dus baat bij heeft.

Verder valt er nog op te merken dat we bij dit proces eerst bepaalde interfaces ge(her)defineerd hebben, zodat we allen konden werken aan afgeronde gehelen. Dit gaf natuurlijk het nadeel dat het volledige programma overhoop lag tot al deze gehelen opnieuw geintegreerd waren. 


\chapter{Werkverdeling}

(a) Geef voor elk van de groepsleden aan aan welke delen ze hebben meegewerkt, en welke
andere taken ze op zich hebben genomen.
(b) Rapporteer in tabelvorm hoeveel uur elk groepslid elke week aan het project gewerkt
heeft, zowel tijdens als buiten de begeleide sessies. Geef ook totalen per groepslid voor
het volledige semester
...
\begin{itemize}
	\item Samenvatting: jaar-overschrijdend $\rightarrow$ jaaroverschrijdend, Pac-Man-spel$\rightarrow$ Pac-Manspel, Open Bron project $\rightarrow$ Open Sourceproject;
	\item Sectie 2.1: ''staat (...) stil in het parcours'': in $\rightarrow$ op;
...
\hline
 & datum & omschrijving Michiel & omschrijving Florian & omschrijving Ruben & omschrijving Thomas & omschrijving Christophe & omschrijving Team & michiel & florian & ruben & thomas & christophe \\ 
\hline
 &  &  &  &  &  &  &  & 198 & 164 & 156,5 & 150 & 201 \\ 
\hline
Mon & 13/feb/12 & commissie & simulator refactoring en nieuwe features & simulator refactoring en nieuwe features, Projectleider & simulator refactoring en nieuwe features &  & P&O sessie,discussie aanpak, research pacman ed,  & 5 & 4 & 6 & 5 & 3 \\ 
\hline
Tue & 14/feb/12 &  &  &  &  & RabbitMQ research &  &  &  & 2 & 3 & 3,5 \\ 
\hline
Wed & 15/feb/12 &  & Sector Opdeling &  &  & AntiObjects &  & 5 & 5 & 5 & 2 & 5 \\ 
\hline
Thu & 16/feb/12 &  &  &  &  & AntiObjects &  &  &  &  &  & 3,5 \\ 
\hline
Vri & 17/feb/12 &  &  &  &  & AntiObjects, RabbitMQ &  & 2 &  &  &  & 0,5 \\ 
\hline
Sat & 18/feb/12 &  &  &  & Sector Opdeling &  &  &  &  &  & 1 & 1 \\ 
\hline
Sun & 19/feb/12 &  &  &  & Sector Opdeling &  &  &  &  &  & 3 &  \\ 
\hline
Mon & 20/feb/12 & Testen IR,commissie &  & Projectleider &  & AntiObjects & P&O sessie & 5 & 5 & 5 & 6 & 4,5 \\ 
\hline
Tue & 21/feb/12 &  &  & IRSeeker &  & AntiObjects,verkenningsstrategie uitwerken &  & 2 & 3 & 4 & 4 & 3 \\ 
\hline
Wed & 22/feb/12 & Testen IR & Testen IR & Testen IR &  & verkenningsstrategie uitwerken & Testen IR & 7,5 & 6 & 5 & 2 & 5 \\ 
\hline
Thu & 23/feb/12 &  &  &  &  & DFS discovery &  &  &  &  &  & 5 \\ 
\hline
Vri & 24/feb/12 &  &  &  &  &  & Driving/map voor bouw robot &  &  &  & 1 &  \\ 
\hline
Sat & 25/feb/12 &  &  &  &  &  & Simulator+behaviour & 2 &  &  & 2 &  \\ 
\hline
Sun & 26/feb/12 &  &  &  &  &  &  &  &  &  &  &  \\ 
\hline
Mon & 27/feb/12 &  &  & Projectleider &  & CD discovery & P&O sessie & 8 & 5 & 6 & 6 & 6 \\ 
\hline
Tue & 28/feb/12 &  &  &  &  & discovery/hunt & verslag & 8,5 & 5 & 7 & 4 & 5,5 \\ 
\hline
Wed & 29/feb/12 &  & verslag &  &  & integratie disc/hunt/comm &  & 7 & 5 & 3 & 1 & 3 \\ 
\hline
Thu & 1-mrt-2012 & onderzoek naar mogelijke verbeteringen op gebied van rondrijden & onderzoek naar mogelijke verbeteringen op gebied van rondrijden & onderzoek naar mogelijke verbeteringen op gebied van rondrijden &  &  &  & 7 &  & 5 & 2 &  \\ 
\hline
Vri & 2-mrt-2012 &  &  &  &  & mini-simulator &  & 2 &  &  &  & 3,5 \\ 
\hline
Sat & 3-mrt-2012 &  &  &  &  & mini-simulator & code bekeken voor verslag &  &  &  & 2 & 6 \\ 
\hline
Sun & 4-mrt-2012 &  &  &  &  & mini-simulator & verslag &  &  &  & 2 & 5 \\ 
\hline
Mon & 5-mrt-2012 & commissie, code integration mini-simulator and real simulator & verslag & Projectleider verslag &  & agents,logging,,grids,... & P&O sessie & 5 & 5 & 5 & 6 & 6,5 \\ 
\hline
Tue & 6-mrt-2012 & lichtsensor herimplementatie & lichtsensor herimplementatie & barcodes, verslag &  & dashboard, verslag & verslag, debugging & 8 & 5 & 6 & 5 & 6 \\ 
\hline
Wed & 7-mrt-2012 & verslag, ghost protocol & verslag, ghost protocol & verslag nalezen &  & AggregatedGrid, verslag &  & 9 & 7 & 7 & 8 & 4 \\ 
\hline
Thu & 8-mrt-2012 & Testen ghost protocol, implementatie RobotBluetoothAgent, schrijven scanner implementatie, aanpassen code voor lejos, schrijven ontbrekende code in lejos & pair programming michiel & MazeProtocol &  & AggregatedGrid &  & 9 & 5 & 4 & 3 & 2 \\ 
\hline
Vri & 9-mrt-2012 & Optimalisatie robot, bespreking memory management, implementatie barcodes in protocol, implementatie grid importing &  & MazeProtocol, IR in simulator, bugfixes &  & AggregatedGrid & Memory Management & 5 & 2 & 3 & 3 & 6 \\ 
\hline
Sat & 10-mrt-2012 &  &  &  &  & ServiceAgent &  &  &  &  &  & 1 \\ 
\hline
Sun & 11-mrt-2012 & refactored unit tests, fixed all build errors, work on grid importing, barcode bugfixing, MQ bugfixing, Dashboard agent implementation &  &  &  & ServiceAgent, UI Server, Dashboard &  & 13 &  & 8 & 3 & 6,5 \\ 
\hline
Mon & 12-mrt-2012 & Barcode bugfixing, grid mapping bugfixing, pacman protocl implementatie, reverse mapping implementatie, dashboardagent implementatie &  & Testen robot, Framerate verhogen op robot, pacman herkennen &  & MiniSimulator,ServiceAgent, UI Server, Dashboard, memory usage improvements & P&O Sessie & 7 & 5 & 6 & 5 & 10 \\ 
\hline
Tue & 13-mrt-2012 &  &  &  & code review: action, bluetooth, driver,... & review code tree &  &  &  &  & 3 & 1 \\ 
\hline
Wed & 14-mrt-2012 &  & Bitwiseoperations &  & code review: map, modelprocessors, sensors &  & Review code tree  &  & 4 & 4,5 & 2 & 3 \\ 
\hline
Thu & 15-mrt-2012 &  &  &  & code review: vizualization + start simulator &  &  &  &  &  & 4 &  \\ 
\hline
Vri & 16-mrt-2012 &  &  &  & code review: simulator &  &  &  &  &  & 2 &  \\ 
\hline
Sat & 17-mrt-2012 &  &  &  & code review: simulator &  &  & 1 &  &  & 2 &  \\ 
\hline
Sun & 18-mrt-2012 &  &  &  &  &  &  &  &  &  &  &  \\ 
\hline
Mon & 19-mrt-2012 & Vergadering + planning, scheidsrechtercommisie, initial model refactoring & verslag  & verslag &  &  & P&O Sessie, overlopen resultaten code review en taakverdeling & 5 & 5 & 5 & 5 & 6 \\ 
\hline
Tue & 20-mrt-2012 & completed model refactoring, merged minisimulator robot implementation with the actual robot implementation, cleanup of robot project &  & verslag & refactoring &  & verslag (performantie,review.merge) &  & 4 &  & 2 & 4 & 4 \\ 
\hline
Wed & 21-mrt-2012 & Added light consistency test, fixed barcode bug, adding barcodes to swinggridview &  & refactoring &  & verslag (merge reviews) & Inleveren verslag 2 & 3 & 2 & 6 & 3 & 2 \\ 
\hline
Thu & 22-mrt-2012 & Added barcodes to the minisimulator &  &  &  & dashboard: multi-robot, local-file source / Agent -> Gateway + UpdatesJSAppender &  & 1 &  &  & 3 & 6 \\ 
\hline
Vri & 23-mrt-2012 &  &  &  &  & SimulationRunner, Gateway(Client) &  &  &  &  & 3 & 7 \\ 
\hline
Sat & 24-mrt-2012 & implementatie gridmerging & verslag rood+colors +dashboardagent+collision & barcodegedrag voor robot &  & SimulatedGatewayClient &  & 6 & 9 & 5 & 12 & 4 \\ 
\hline
Sun & 25-mrt-2012 & implementatie gridmerging & ill be there prob & Robot, bluetooth & memorytests &  & Local Dashboard & co &  & 7 & 7 & 3 & 6 & 7 \\ 
\hline
Mon & 26-mrt-2012 &  &  &  &  & Dashboard, DashboardReporter, GhostProtocol,  & P&O Sessie / Demo 2 & 5 & 8 & 5 & 5 & 10 \\ 
\hline
...
Thu & 29-mrt-2012 &  &  &  &  &  &  &  &  &  &  &  \\ 
\hline
Vri & 30-mrt-2012 &  &  &  &  & unit tests &  &  &  &  &  & 3 \\ 
\hline
Sat & 31-mrt-2012 & Unit testen voor grid package &  &  &  &  &  & 6 &  &  &  &  \\ 
\hline
Sun & 1/apr/12 & Transformatietesten grid &  &  &  &  &  & 3 &  &  &  &  \\ 
\hline
Mon & 2/apr/12 & Sector interface &  &  &  &  & Paasvakantie & 3 &  &  &  &  \\ 
\hline
Tue & 3/apr/12 &  &  &  &  &  & Paasvakantie &  &  &  &  &  \\ 
\hline
Wed & 4/apr/12 &  &  &  &  &  & Paasvakantie &  &  &  &  &  \\ 
\hline
Thu & 5/apr/12 &  &  &  &  & unit tests & Paasvakantie &  &  &  &  & 6 \\ 
\hline
Vri & 6/apr/12 &  &  &  &  & unit tests & Paasvakantie &  &  &  &  & 3 \\ 
\hline
Sat & 7/apr/12 &  &  &  &  & unit tests & Paasvakantie &  &  &  &  & 3 \\ 
\hline
Sun & 8/apr/12 &  &  &  &  & unit tests & Paasvakantie &  &  &  &  & 1 \\ 
\hline
Mon & 9/apr/12 &  &  &  &  &  & Paasvakantie &  &  &  &  &  \\ 
\hline
Tue & 10/apr/12 &  &  &  &  & unit tests & Paasvakantie &  &  &  &  & 2 \\ 
\hline
Wed & 11/apr/12 &  &  &  &  & unit tests & Paasvakantie &  &  &  &  & 1 \\ 
\hline
Thu & 12/apr/12 &  &  &  &  & unit tests & Paasvakantie &  &  &  &  & 4 \\ 
\hline
Vri & 13/apr/12 &  &  &  &  & unit tests & Paasvakantie &  &  &  &  & 4 \\ 
\hline
Sat & 14/apr/12 &  &  &  &  &  & Paasvakantie &  &  &  &  &  \\ 
\hline
Sun & 15/apr/12 &  &  &  &  &  & Paasvakantie &  &  &  &  &  \\ 
\hline
Mon & 16/apr/12 &  &  & unit_testen map &  &  & P&O Sessie & 5 & 5 & 5 & 5 & 2 \\ 
\hline
Tue & 17/apr/12 &  &  &  &  &  &  &  & 3 &  &  &  \\ 
\hline
Wed & 18/apr/12 &  &  &  &  &  &  &  & 5 &  &  &  \\ 
...
Vri & 20/apr/12 &  &  &  &  &  &  &  &  &  &  &  \\ 
\hline
Sat & 21/apr/12 &  &  & unit_testen simulator &  &  &  &  & 6 & 8 &  &  \\ 
\hline
Sun & 22/apr/12 & Mergen branches + fixen various tests, Implementatie LinkedSector + testen &  & unit_testen sensoren &  &  &  & 6 &  & 5 &  &  \\ 
\hline
Mon & 23/apr/12 & Interface grid + implementatie, compilation errors in test fixen &  & unit_testen sensoren &  &  & P&O Sessie & 5 & 5 & 6 & 5 & 3 \\ 
\hline
Tue & 24/apr/12 & Implementatie Linkedgrid &  &  &  & fixed off-by-one bug in CircularQueue &  & 2 & 4 & 2 &  & 1 \\ 
\hline
Wed & 25/apr/12 & Testen Linkedgrid &  &  &  &  &  & 4 & 4 &  &  &  \\ 
\hline
Thu & 26/apr/12 &  &  &  &  &  &  &  & 3 &  &  &  \\ 
\hline
Vri & 27/apr/12 &  &  &  &  &  &  &  & 2 &  &  &  \\ 
...
Sun & 29/apr/12 &  &  &  &  &  &  & 8 & 2 &  &  &  \\ 
\hline
Mon & 30/apr/12 &  &  &  &  &  & P&O Sessie & 5 & 10 & 5 & 5 & 2 \\ 
\hline
Tue & 1/mei/12 &  &  &  &  &  &  &  &  &  &  &  \\ 
\hline
...
Sun & 6/mei/12 &  &  &  &  &  &  &  &  &  &  &  \\ 
\hline
Mon & 7/mei/12 &  &  &  &  &  & Finale Demo & 1 & 1 & 1 & 1 & 2 \\ 
\hline
Tue & 8/mei/12 &  &  &  &  &  &  &  &  &  &  &  \\ 
\hline
...
Sun & 13/mei/12 &  &  &  &  &  &  &  &  &  &  &  \\ 
\hline
Mon & 14/mei/12 &  &  &  &  &  & Finale Presentatie & 1 & 1 & 1 & 1 & 2 \\ 
\hline
\end{tabular}
\end{sideways}
