...
\begin{figure}
	...
	\begin{tikzpicture}
		\begin{axis}[xmin=0,xmax=5,ymin=-2.0, ymax=0.2,
...
Op basis van de resultaten, werd de wielomtrek 1\% verkleind. De test werd niet integraal hernomen, maar de resultaten van de testen met veelhoeken waren substantieel beter.\subsubsection{Test 2: een vaste afstand met verschillende snelheden}
...
\begin{figure}
	\caption{Test 2 : Relatieve afwijking bij vaste snelheid}
	\label{chart:test2}
	\vspace{10pt}	
	\centering
...
1.6	& (statistische) verwerking				& Thomas				& \\
