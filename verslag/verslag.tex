...
Nota: De samenvatting wordt later verder aangevuld met belangrijke aspecten die tijdens het verdere verloop van het project naar voor treden.
...
Voor het volgen van een lijn maken we gebruik van een grijswaardesensor. Deze werd vooraan op de robot bevestigd. Om de sensoren makkelijker en beter te kunnen bevestigen, werd de robot structureel anders opgebouwd.
...
\begin{figure}
	\caption{Relatieve afwijking t.o.v. gemiddelde gemeten grijswaarde voor bruin}
	\label{chart:bruin}
	\vspace{10pt}	
	\centering
...
\begin{figure}
	\caption{Relatieve afwijking t.o.v. gemiddelde gemeten grijswaarde voor wit}
	\label{chart:wit}
	\vspace{10pt}	
	\centering
...
\begin{figure}
	\caption{Relatieve afwijking t.o.v. gemiddelde gemeten grijswaarde voor zwart}
	\label{chart:zwart}
	\vspace{10pt}	
	\centering
...
In een eerste test bepaalden we de afwijking op een afstandsmeting van 1 tot 60cm. Figuur \ref{chart:sonarDistance} geeft de relatieve fout weer op de gemeten afstanden.
...
Een robot zal niet steeds loodrecht staan t.o.v. een obstakel. Om na te gaan hoeveel de meetresultaten afwijken onder een hoek, hebben we een test gedaan waarbij we onder een hoek van 0, 5, 10, 15, 30 en 45 graden de gemeten afstand vergeleken met de werkelijke afstand. Figuur \ref{chart:sonarAngle} geeft de relatieve afwijking van de meting tov de werkelijkheid weer.
...
\item gebruik een tabel om de effectief gedetecteerde waarde om te zetten naar een gecorrigeerde mogelijke waarde, volgens de ge\"integreerde Hamming-code error-correctie
\end{enumerate}
...
Thomas 		&	RobotAPI, lichtsensor, barcodelezer, UI \\
...
\hline 
\endhead
totaal    & 57 & 38 & 41 & 38 & 34 & 78 \\
\hline
week 1 & 10 & 10 & 10 & 10 & 10 & 15 \\
week 2 & 9 & 7 & 8 & 7 & 9 & 16 \\
week 3 & 8 & 8 & 8 & 8 & 5 & 12 \\
week 4 & 9 & 7 & 5 & 8 & 5 & 17 \\
week 5\footnote{Week 5 is nog bezig ten tijde van inlevering verslag.} & 21 & 6 & 10 & 5 & 5 & 18 \\
\hline
