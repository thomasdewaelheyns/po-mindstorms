...
\section{Refactoring}
Een groot deel van de tijd voor demo 2 is gespendeerd geweest aan het refactoren van onze code. Aan de hand van een grondige analyse van de code zijn bepaalde pijnpunten aangeduid die door de grote veranderingen tussen semester 1 en semester 2 niet uitbreidbaar meer waren. Deze punten zijn besproken geweest en zijn voor demo 2 indien mogelijk aangepakt geweest. 

Zo is de grote hoeveelheid informatie in het GhostModel opgesplits geweest in verschillende delen om de koppeling te verminderen. Verder zijn er kleine aanpassingen gedaan om het geheugengebruik verder te verminderen. En algemene bruikbaarheid.
