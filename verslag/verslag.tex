...
Voor het bepalen van de waarden waarbinnen we besluiten of een kleur bruin, wit of zwart is, bekijken we de resultaten in absolute vorm over alle metingen heen. Figuur \ref{chart:kleuren} illustreert de bereiken van de drie verschillende kleuren. Hierbij merken we op, dat ofschoon zwart een grotere potenti\"ele relatieve afwijking kent, dit in praktijk geen probleem zal opleveren. Het bereik van de metingen voor zwart ligt ver van het bereik van bruin en wit. Deze twee laatsten daarentegen hebben wel minima en maxima die in elkaars buurt liggen en potentieel kunnen zorgen voor "valse positieven" in beide richtingen. 
