...
public class BarcodeTest {
  ...
  public void testSimulator() {
    ...
    BarcodeRobot barcodeRobot = new BarcodeRobot();
    barcodeRobot.setModel(new BarcodeModel());
    barcodeRobot.setModel(spyMockModel(barcodeRobot.getModel()));
    ManhattanDriver manhattan = new BarcodeDriver(Sector.SIZE/100.0);
    Navigator ghostNavigator = new GhostNavigator();
    barcodeRobot.useDriver(manhattan).useNavigator(ghostNavigator);
    SimulatedEntity simE = SimulatedEntityFactory.make(barcodeRobot);
