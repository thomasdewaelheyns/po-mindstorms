...
public class MapUtilTest extends TestCase {
  ...
  public void testFindHitDistance() {
    ...
    assertEquals(Integer.MAX_VALUE, MapUtil.findHitDistance(map, -44, 20.0, 20.0));
    assertEquals(61, MapUtil.findHitDistance(map, -71, 20.0, 20.0));
    assertEquals(104, MapUtil.findHitDistance(map, -72, 20.0, 20.0));
  }
  ...
  public void testFindHitDistance1() {
    ...
    assertEquals(Integer.MAX_VALUE, values[3], 0.01);
    findDirectionedValues2(m, 2, 2, 1, 39.99);
    assertEquals(Integer.MAX_VALUE, values[0], 0.01);
    ...
    findDirectionedValues2(m, 3, 1, 39.99, 0);
    assertEquals(Integer.MAX_VALUE, values[0], 0.01);
    assertEquals(Integer.MAX_VALUE, values[1], 0.01);
    assertEquals(Integer.MAX_VALUE, values[2], 0.01);
    assertEquals(39, values[3], 0.01);
  }
  ...
  public void testPart2(){
    ...
    assertEquals(1, values[0], 0.01);
    assertEquals(Integer.MAX_VALUE, values[1], 0.01);
    assertEquals(39, values[2], 0.01);
    ...
    assertEquals(Integer.MAX_VALUE, values[2], 0.01);
    assertEquals(20, values[3], 0.01);
    findDirectionedValues2(m, 3, 3, 39.99, 39.99);
    assertEquals(Integer.MAX_VALUE, values[0], 0.01);
    assertEquals(Integer.MAX_VALUE, values[1], 0.01);
    assertEquals(Integer.MAX_VALUE, values[2], 0.01);
    assertEquals(Integer.MAX_VALUE, values[3], 0.01);
  ...
  private void findDirectionedValues(Map m, int left, int top) {
    findDirectionedValues2(m, left, top, 20.0, 20.0);
  }

  private void findDirectionedValues2(Map m, int left, int top, double x, double y) {
    values = new double[4];
    values[0] = MapUtil.findHitDistance(m, 90, x + left * 40 - 40, y + top * 40 - 40);
    values[1] = MapUtil.findHitDistance(m, 0, x + left * 40 - 40, y + top * 40 - 40);
    values[2] = MapUtil.findHitDistance(m, 270, x + left * 40 - 40, y + top * 40 - 40);
    values[3] = MapUtil.findHitDistance(m, 180, x + left * 40 - 40, y + top * 40 - 40);
  }
